...
public final class DataAssetServicesFactory {
     ...
     */
    public static DataAssetServices apply(DataShopConfiguration configuration, DataAssetEntities dataAssets, WorkspacesServicePort workspaces,
                                          DataAssetProviders providers) {
        var comp = DataAssetServicesCompanion.apply(dataAssets, workspaces);
        var impl = DataAssetServicesImpl.apply(dataAssets, workspaces, providers, comp);
