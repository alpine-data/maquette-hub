...
public class DataAssetPermissions {
    ...
    public static DataAssetPermissions forUser(User executor, List<GrantedAuthorization<DataAssetMemberRole>> members,
                                               boolean isSubscriber) {
        var isOwner = members
            .stream()
            .anyMatch(m -> m
                .getRole()
                .equals(DataAssetMemberRole.OWNER) && m
                .getAuthorization()
                .authorizes(executor));
        var isSteward = members
            .stream()
            .anyMatch(m -> m
                .getRole()
                .equals(DataAssetMemberRole.STEWARD) && m
                .getAuthorization()
                .authorizes(executor));
        var isConsumer = members
            .stream()
            .anyMatch(m -> m
                .getRole()
                .equals(DataAssetMemberRole.CONSUMER) && m
                .getAuthorization()
                .authorizes(executor));
        var isProducer = members
            .stream()
            .anyMatch(m -> m
                .getRole()
                .equals(DataAssetMemberRole.PRODUCER) && m
                .getAuthorization()
                .authorizes(executor));
        var isMember = members
            ...
            .anyMatch(m -> m
                .getRole()
                .equals(DataAssetMemberRole.MEMBER) && m
                .getAuthorization()
                .authorizes(executor));
