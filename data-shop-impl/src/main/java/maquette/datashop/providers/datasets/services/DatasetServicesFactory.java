...
public final class DatasetServicesFactory {
   ...
   public static DatasetServices apply(MaquetteRuntime runtime, DatasetsRepository repository, DatasetDataExplorer dataExplorer, WorkspaceEntities workspaces) {
