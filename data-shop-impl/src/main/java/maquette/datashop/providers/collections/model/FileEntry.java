...
public abstract class FileEntry {
    ...
    public static class Directory extends FileEntry {
        ...
        /**
         * Removes a file from the map of children and returns the updated directory object.
         *
         * @param name The name (including directories) of the file.
         * @return The updated directory object.
         */
         ...
         */
        private void toStringTree(int indent, StringBuilder sb) {
            var c = children
                .keySet()
                .stream()
                .sorted()
            ...
            for (int i = 0; i < c.size(); i++) {
                ...
                if (element instanceof Directory) {
                    ((Directory) element).toStringTree(indent + 3, sb);
                }
            }
        }
