...
/**
 * A data asset provider is a concrete implementation of a data asset (e.g. connecting to a database, or some file storage).
 */
public interface DataAssetProvider {
   ...
   /**
    * Returns a set of provider-specific custom commands. The key is the command, the value is the implementation of the command.
    *
    * @return The commands.
    */
