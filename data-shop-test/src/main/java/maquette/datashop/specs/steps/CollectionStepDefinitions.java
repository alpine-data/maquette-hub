...
public class CollectionStepDefinitions extends DataAssetStepDefinitions {
    ...
    public void $_uploads_file_$_to_collection_$(AuthenticatedUser user, String collection,
    ...
    public void $_downloads_file_$_from_collection_$(AuthenticatedUser user, String collection,
                                                     String fileName) throws ExecutionException, InterruptedException {
        var collections = this
            .runtime
            .getModule(MaquetteDataShop.class)
    ...
    public void $_uploads_dir_$_to_collection_$(AuthenticatedUser user, String collection,
                                                String zipName) throws ExecutionException, InterruptedException {
        var collections = this
            .runtime
            .getModule(MaquetteDataShop.class)
            .getProviders()
    ...
    public void $_creates_tag_$_for_collection_$(AuthenticatedUser user, String collection,
                                                 String tagName) throws ExecutionException, InterruptedException {
        var collections = this
            .runtime
            .getModule(MaquetteDataShop.class)
            .getProviders()
    ...
    public void $_deletes_file_$_from_collection_$(AuthenticatedUser user, String collection,
                                                   String fileName) throws ExecutionException, InterruptedException {
        var collections = this
            .runtime
            .getModule(MaquetteDataShop.class)
    ...
    public void the_uploaded_files_should_equal_the_downloaded_files() throws IOException {
        var uploaded = new File(this.uploaded
            .get(this.uploaded.size() - 1)
            .toString());
        var downloaded = new File(this.downloaded
            .get(this.downloaded.size() - 1)
            .toString());

        assert (FileUtils.contentEquals(uploaded, downloaded));
    }

    public void the_uploaded_files_should_be_listed_in_collection_files(AuthenticatedUser user, String collection,
                                                                        String tag,
                                                                        List<String> uploadedFiles) throws ExecutionException, InterruptedException {
        var collections = this
            .runtime
            .getModule(MaquetteDataShop.class)
            .getProviders()
    ...
    public void the_deleted_files_should_not_be_listed_in_collection_files(AuthenticatedUser user, String collection,
                                                                           List<String> deletedFiles) throws ExecutionException, InterruptedException {
        var collections = this
            .runtime
            .getModule(MaquetteDataShop.class)
            .getProviders()
        ...
        files = collections
            .getServices()
            .listFiles(user, collection, null)
            .toCompletableFuture()
            .get();

        Set<String> intersection = files
            .stream()
            .distinct()
