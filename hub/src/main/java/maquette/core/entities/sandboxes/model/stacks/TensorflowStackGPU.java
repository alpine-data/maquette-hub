...
public class TensorflowStackGPU implements Stack<TensorflowStackGPU.Configuration> {

   public static final String STACK_NAME = "tensorflow-gpu";

   @Override
   public String getTitle() {
      return "Python with Tensorflow (GPU)";
   }
