...
public class RStudioStack implements Stack<RStudioStack.Configuration> {

   public static final String STACK_NAME = "r-studio";
   ...
   public String getSummary() {
      return "Get a running R Studio instance.";
   }
