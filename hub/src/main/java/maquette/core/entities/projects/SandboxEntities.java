...
import maquette.core.entities.projects.exceptions.SandboxNotFoundException;
...
public final class SandboxEntities {
   ...
   public CompletionStage<SandboxProperties> createSandbox(
      User executor, UID project, UID volume, String name) {
      var sandbox = SandboxProperties.apply(UID.apply(), project, volume, name, ActionMetadata.apply(executor));
