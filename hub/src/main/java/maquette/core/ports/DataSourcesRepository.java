...
public interface DataSourcesRepository extends
   DataAssetRepository<DataSourceProperties>, HasDataAccessRequests,
   HasMembers<DataAssetMemberRole>, HasAccessLogs {
