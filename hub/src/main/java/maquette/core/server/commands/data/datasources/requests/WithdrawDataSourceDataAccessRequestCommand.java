...
public class WithdrawDataSourceDataAccessRequestCommand implements Command {
   ...
   public Command example() {
      return WithdrawDataSourceDataAccessRequestCommand.apply("some-data-source", UID.apply(), Operators.lorem());
   }
}
