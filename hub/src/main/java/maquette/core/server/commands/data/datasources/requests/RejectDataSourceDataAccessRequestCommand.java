...
public class RejectDataSourceDataAccessRequestCommand implements Command {
   ...
   public Command example() {
      return RejectDataSourceDataAccessRequestCommand.apply("some-data-source", UID.apply(), Operators.lorem());
   }
}
