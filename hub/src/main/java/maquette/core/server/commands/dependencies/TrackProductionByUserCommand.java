...
public class TrackProductionByUserCommand implements Command {
   ...
   public CompletionStage<CommandResult> run(User user, RuntimeConfiguration runtime, ApplicationServices services) {
      return services
         ...
         .trackProductionByUser(user, type, asset, user.getDisplayName())
         .thenApply(done -> MessageResult.apply("Ok"));
   }

   @Override
   public Command example() {
      return TrackProductionByUserCommand.apply(
