...
public class UpdateStreamDataAccessRequestCommand implements Command {
   ...
   public Command example() {
      return UpdateStreamDataAccessRequestCommand.apply("some-stream", UID.apply(), Operators.lorem());
   }
}
