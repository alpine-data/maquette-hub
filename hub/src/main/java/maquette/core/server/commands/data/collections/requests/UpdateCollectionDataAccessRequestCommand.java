...
public class UpdateCollectionDataAccessRequestCommand implements Command {
   ...
   public Command example() {
      return UpdateCollectionDataAccessRequestCommand.apply("some-collection", UID.apply(), Operators.lorem());
   }
}
