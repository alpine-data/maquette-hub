package maquette.common.config;
...
public final class Configs {
   ...
   private static final String roleName = system.hasPath(SYS_MAQUETTE_ROLE) ?
      system.getString(SYS_MAQUETTE_ROLE) : environment.hasPath(ENV_ALPAKKEER_ROLE) ? environment.getString(ENV_ALPAKKEER_ROLE) : null;
         ...
         FieldUtils
            ...
            .forEach(field -> {
               ...
               try {
                  ...
                  if (field.getAnnotationsByType(maquette.common.config.annotations.Optional.class).length == 0) {
