...
def get_statistics(project_name: str, dataset_name: str, version: str) -> ResponseBody:
    return ResponseBody(columns=generate_df_statistics(__load_df(project_name, dataset_name, version)),
