 ...
 *
 * Note! Per convention all values retrieved from infrastructure provide should be Base64 encoded. Thus, the class offers methods
...
public class StackInstanceParameters {
    ...
    */
   public static StackInstanceParameters create(String entrypointEncoded, String entrypointLabelEncoded, Map<String, String> parametersEncoded) {
   ...
   public static StackInstanceParameters encodeAndCreate(String entrypoint, String entrypointLabel, Map<String, String> parameters) {
      ...
      for (var key : parameters.keySet()) {
         parametersEncoded.put(key, Base64.getEncoder().encodeToString(parameters.get(key).getBytes()));
      }
   ...
   public Map<String, String> getParametersDecoded() {
      ...
      for (var key : this.parameters.keySet()) {
         decoded.put(key, new String(Base64.getDecoder().decode(this.parameters.get(key))));
      }
