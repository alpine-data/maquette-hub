...
public interface ModelsRepository {
   ...
   CompletionStage<List<GrantedAuthorization<ModelMemberRole>>> findMembersByRole(UID workspace, String model, ModelMemberRole role);

   CompletionStage<Done> insertOrUpdateMember(UID workspace, String model, GrantedAuthorization<ModelMemberRole> member);
