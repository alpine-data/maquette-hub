...
function SourceOverview(props) {
  const schema = _.get(props, 'source.view.source.schema');
  const records = _.get(props, 'source.view.source.records');
  const statistics = _.get(props, 'source.view.source.statistics.columns') || [];
