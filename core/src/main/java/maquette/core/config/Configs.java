...
public final class Configs {
    ...
    private static final String environmentName = system.hasPath(SYS_MAQUETTE_ENVIRONMENT) ?
        system.getString(SYS_MAQUETTE_ENVIRONMENT) : environment.hasPath(ENV_MAQUETTE_ENVIRONMENT) ?
        environment.getString(ENV_MAQUETTE_ENVIRONMENT) : LOCAL_ENVIRONMENT;
    ...
    private static final String roleName = system.hasPath(SYS_MAQUETTE_ROLE) ?
        system.getString(SYS_MAQUETTE_ROLE) : environment.hasPath(ENV_MAQUETTE_ROLE) ?
        environment.getString(ENV_MAQUETTE_ROLE) : null;
    ...
    private static class ConfigBuilder {
         ...
         * {@link ConfigBuilder#SYS_MAQUETTE_ENVIRONMENT}.
         *
