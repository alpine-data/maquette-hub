...
public final class Configs {
   ...
   /**
    * The name of the current environment, based on "maquette.environment" system environment variable.
    */
   private static final String environmentName = system.hasPath(SYS_MAQUETTE_ENVIRONMENT) ?
      system.getString(SYS_MAQUETTE_ENVIRONMENT) : environment.hasPath(ENV_MAQUETTE_ENVIRONMENT) ? environment.getString(ENV_MAQUETTE_ENVIRONMENT) : LOCAL_ENVIRONMENT;

   /**
    * The name of the current instance's role, based on "maquette.role" system environment variable.
    */
   private static final String roleName = system.hasPath(SYS_MAQUETTE_ROLE) ?
      system.getString(SYS_MAQUETTE_ROLE) : environment.hasPath(ENV_MAQUETTE_ROLE) ? environment.getString(ENV_MAQUETTE_ROLE) : null;
   ...
   /**
    * @return The name of the current environment, based on "maquette.environment" system environment variable.
    */
   ...
   /**
    * @return The name of the current instance's role, based on "maquette.role" system environment variable.
    */
               ...
               try {
                  ...
                  if (field.getType().equals(Boolean.class) || field.getType().equals(boolean.class)) {
                     ...
                     if (genericType.equals(Boolean.class)) {
                        ...
                        LOG.warn(String.format("Field '%s.%s' has unknown generic type for configuration: List<%s>", configClass.getSimpleName(), field.getName(), genericType));
                     }
                  } else {
   ...
   private static class ConfigBuilder {
       ...
       * <p>
       * The environment name can be set in the system variable/ JVM argument {@link ConfigBuilder#SYS_MAQUETTE_ENVIRONMENT}.
       *
       ...
       * <p>
       * The role can be defined in the system variable/ JVM argument {@link ConfigBuilder#SYS_MAQUETTE_ROLE}.
       *
       * @return A new {@link ConfigBuilder} instance
       */
