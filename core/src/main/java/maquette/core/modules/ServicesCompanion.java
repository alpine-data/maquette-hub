...
public class ServicesCompanion {
   ...
   /**
    * Chains a list of authorization checks. If one check is successful, the passThrough will be returned, otherwise an empty value will be returned.
    *
    ...
    * an {@link NotAuthorizedException} will be thrown. A single successful result will continue to process (return Done).
    *
    * @param checks The list of checks to execute.
